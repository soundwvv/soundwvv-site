...
const OnDemandSoundSection = () => {
  ...
  return (
    <section className="py-12 lg:py-16 bg-black border-t border-white/10">
      <div className="max-w-[1920px] mx-auto px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Horizontal list with separators - increased font size */}
          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-4 text-white/80 text-lg lg:text-xl mb-6">
